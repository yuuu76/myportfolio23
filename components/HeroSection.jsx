          ...
          >
            <h1 className="font-extrabold">
              ...
              <span className="text-white text-8xl ">
                Hello, I'm{" "} 
                <span className="text-transparent bg-clip-text sm:text-8xl md:text-9xl bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500">
                Wan Qi
                </span>
              </span>
              <br></br>
              ...
              <TypeWritter
                ...
                onInit={(typewriter) => {
                    ...
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#9E7BFF">Business Analyst</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#893BFF">Day Dreamer</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .start();
